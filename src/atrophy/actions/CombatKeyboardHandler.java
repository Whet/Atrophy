...
public class CombatKeyboardHandler extends KeyboardHandler {
	...
	public CombatKeyboardHandler(MouseAbilityHandler mouseAbilityHandler, TurnProcess turnProcess, AiManagementSuite aiManagementSuite, UiUpdaterSuite uiUpdaterSuite){
