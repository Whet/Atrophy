...
public abstract class VisualEffect {
	...
	public static class ShotgunBullet extends Bullet {
		...
		public ShotgunBullet(PanningManager panningManager, double[] location, double[] targetLocation, Color colour, double speed) {
			...
			this.angle[1] = Maths.getRads(location[0], location[1], targetLocation[0], targetLocation[1])+ (Math.random() * (Math.PI / 16));
			this.angle[2] = Maths.getRads(location[0], location[1], targetLocation[0], targetLocation[1])+ (Math.random() * (Math.PI / 16));
			this.angle[3] = Maths.getRads(location[0], location[1], targetLocation[0], targetLocation[1])- (Math.random() * (Math.PI / 16));
			this.angle[4] = Maths.getRads(location[0], location[1], targetLocation[0], targetLocation[1])- (Math.random() * (Math.PI / 16));
