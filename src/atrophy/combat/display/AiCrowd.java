...
public class AiCrowd extends Crowd {
	...
	public AiCrowd(Squad squad, TurnOrderer turnOrderer) {
		super(false);
		images = new HashMap<>();
	...
	public void replaceAi(Ai ai, Ai newAi) {
		this.turnOrderer.replaceAi(ai, newAi);
	}
