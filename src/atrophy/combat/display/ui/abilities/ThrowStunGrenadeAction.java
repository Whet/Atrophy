...
/**
 * The Class ThrowStunGrenadeAction.
 */
public class ThrowStunGrenadeAction extends AbilityButton implements InfoTextDisplayable{

	/**
	 * Instantiates a new throw stun grenade action.
	 *
	 * @param tag the tag
	 * @param image the image
	 */
	public ThrowStunGrenadeAction(String tag, BufferedImage image) {
		super(tag, image);
	}
	...
	public boolean mC(Point mousePosition, MouseEvent e){
		mouseAbilityHandler.setAbility(Abilities.STUNGRENADETHROWER);
