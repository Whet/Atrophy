...
/**
 * The Class BlockDoorAction.
 */
public class BlockDoorAction extends AbilityButton implements InfoTextDisplayable{

	/**
	 * Instantiates a new block door action.
	 *
	 * @param tag the tag
	...
	public boolean mC(Point mousePosition, MouseEvent e){
		combatMembersManager.getCurrentAi().setWelding();
